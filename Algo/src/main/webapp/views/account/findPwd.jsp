...
<!-- css 추가 -->
<link rel="stylesheet" href="${ path }/resources/css/account/findPwd.css">
		...
		<section>
			<div>
				<img src="https://i.ibb.co/K6dj7KV/logo-3.png" alt="로고"
					...
					style="font-size: 30px; color: #003566">비밀번호 찾기</strong>
			</div>
			<div>
				<div class="acc-table">
					<table>
					...
					<div style="margin: -50px auto; text-align: center">
						<button class="algo_btn1" type="submit" onclick="location.href='${ path }/account/newPwd'">비밀번호 찾기</button>
					</div>
				</div>
			</div>
		</section>
